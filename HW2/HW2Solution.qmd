...
tibble and used the 'is.tibble' command to check if it is a tibble.
...
plot1 <- ggplot(data = plot_icu_stay) + 
  ...
  labs(x = "Number of subject ids with specific number of ICU stays", 
       y = "Number of ICU stays per 'subject id") 
plot1
```
