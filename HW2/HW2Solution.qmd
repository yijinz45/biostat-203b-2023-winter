...
**Solution: **
There are a lot of white people in the false group.
...
**Solution:**
There are more english speakers in both group. 
...
**Solution:**
Most people are married. The ratio within in the marital_status is the same 
between 30 days died and survived groups. 
...
**Solution:** There peopoloe who dies within 30 daya were older than those who 
did not. 
...
coord_cartesian(ylim = quantile(mimic_icu_cohort[i], c(0.1, 0.9), na.rm = T))) 
  }
```
The first 8 plots are `thirty_day_mort` vs first lab measurements and the last
5 plots are `thirty_day_mort` vs first vital measurements. 
