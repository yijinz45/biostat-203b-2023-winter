...
**Solution:**  There are a lot of outliers in this data. 
We could also set the limit or delete thos outliers for the boxplot too.
I keep them in there because they are meaningful. Some of These Outliers can be 
informative about the subject-area anddata collection process. We could figure 
out how outliers occur and whether they might happen as a normal part of the study. 
...
mimic_icu_cohort <- icustays_tble %>%
  ...
  mutate(thirty_day_point = ifelse(is.na(deathtime), "FALSE", 
