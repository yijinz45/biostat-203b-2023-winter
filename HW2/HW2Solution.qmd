...
```{r}
system.time(rbase<-read.csv(file="~/mimic/core/admissions.csv.gz"))
system.time(rtidy<-read_csv("~/mimic/core/admissions.csv.gz"))
system.time(rfread<-fread("~/mimic/core/admissions.csv.gz"))
```
...
**Solution:**
Based on the result, the The fread is the fasest function.
The read_csv flat files into DataFrame. The read.csv() function import a CSV file into a DataFrame. fread() function returns you a data table:
